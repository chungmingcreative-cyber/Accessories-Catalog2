...
return e},"es6","es3");$jscomp.polyfill("Object.values",function(b){return b?b:function(c){var d=[],e;for(e in c)$jscomp.owns(c,e)&&d.push(c[e]);return d}},"es8","es3");
...
BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var n=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,u=e*k,B=0,w=0,v=0,t=0;toolBar&&(B=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+
10,w=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,v=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,t=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var x=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-t;l=-l-h*e*d.parameters.zoomArea.left/100+v}else x=-l-h*e*d.parameters.zoomArea.left/100+v,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-t;u>windowHeight?(h=windowHeight-u-n+k*e*d.parameters.zoomArea.bottom/100-w,d=-n-k*e*d.parameters.zoomArea.top/
100+B):(h=-n-k*e*d.parameters.zoomArea.top/100+B,d=windowHeight-u-n+k*e*d.parameters.zoomArea.bottom/100-w);g=Number.between(g,x,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||!e.pointers||0>=e.pointers.length||
...
u){n(p,u,"Sine")}).animation(this,300)}.bind(this),n=function(p,u,B){if(p<u){B=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,u);var w=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,u);p=k(null,p,this.parameters.scale,d-this.parameters.scale,u);u={};u.scale=p;u.tran={x:B,y:w};B=transformCSS(u);this.css(B)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);
...
u.data[k+1]/255*w.g),u.data[k+2]!=w.b&&(B.data[k+2]=u.data[k+2]/255*w.b));h.putImageData(B,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(t){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(x){}})}}}}};
...
(function(b){function c(w,v){var t=(w&65535)+(v&65535);return(w>>16)+(v>>16)+(t>>16)<<16|t&65535}function d(w,v,t,x,y,A){w=c(c(v,w),c(x,A));return c(w<<y|w>>>32-y,t)}function e(w,v,t,x,y,A,G){return d(v&t|~v&x,w,v,y,A,G)}function f(w,v,t,x,y,A,G){return d(v&x|t&~x,w,v,y,A,G)}function g(w,v,t,x,y,A,G){return d(t^(v|~x),w,v,y,A,G)}function h(w,v){w[v>>5]|=128<<v%32;w[(v+64>>>9<<4)+14]=v;var t=1732584193,x=-271733879,y=-1732584194,A=271733878;for(v=0;v<w.length;v+=16){var G=t;var F=x;var O=y;var L=A;
t=e(t,x,y,A,w[v],7,-680876936);A=e(A,t,x,y,w[v+1],12,-389564586);y=e(y,A,t,x,w[v+2],17,606105819);x=e(x,y,A,t,w[v+3],22,-1044525330);t=e(t,x,y,A,w[v+4],7,-176418897);A=e(A,t,x,y,w[v+5],12,1200080426);y=e(y,A,t,x,w[v+6],17,-1473231341);x=e(x,y,A,t,w[v+7],22,-45705983);t=e(t,x,y,A,w[v+8],7,1770035416);A=e(A,t,x,y,w[v+9],12,-1958414417);y=e(y,A,t,x,w[v+10],17,-42063);x=e(x,y,A,t,w[v+11],22,-1990404162);t=e(t,x,y,A,w[v+12],7,1804603682);A=e(A,t,x,y,w[v+13],12,-40341101);y=e(y,A,t,x,w[v+14],17,-1502002290);
x=e(x,y,A,t,w[v+15],22,1236535329);t=f(t,x,y,A,w[v+1],5,-165796510);A=f(A,t,x,y,w[v+6],9,-1069501632);y=f(y,A,t,x,w[v+11],14,643717713);x=f(x,y,A,t,w[v],20,-373897302);t=f(t,x,y,A,w[v+5],5,-701558691);A=f(A,t,x,y,w[v+10],9,38016083);y=f(y,A,t,x,w[v+15],14,-660478335);x=f(x,y,A,t,w[v+4],20,-405537848);t=f(t,x,y,A,w[v+9],5,568446438);A=f(A,t,x,y,w[v+14],9,-1019803690);y=f(y,A,t,x,w[v+3],14,-187363961);x=f(x,y,A,t,w[v+8],20,1163531501);t=f(t,x,y,A,w[v+13],5,-1444681467);A=f(A,t,x,y,w[v+2],9,-51403784);
y=f(y,A,t,x,w[v+7],14,1735328473);x=f(x,y,A,t,w[v+12],20,-1926607734);t=d(x^y^A,t,x,w[v+5],4,-378558);A=d(t^x^y,A,t,w[v+8],11,-2022574463);y=d(A^t^x,y,A,w[v+11],16,1839030562);x=d(y^A^t,x,y,w[v+14],23,-35309556);t=d(x^y^A,t,x,w[v+1],4,-1530992060);A=d(t^x^y,A,t,w[v+4],11,1272893353);y=d(A^t^x,y,A,w[v+7],16,-155497632);x=d(y^A^t,x,y,w[v+10],23,-1094730640);t=d(x^y^A,t,x,w[v+13],4,681279174);A=d(t^x^y,A,t,w[v],11,-358537222);y=d(A^t^x,y,A,w[v+3],16,-722521979);x=d(y^A^t,x,y,w[v+6],23,76029189);t=d(x^
y^A,t,x,w[v+9],4,-640364487);A=d(t^x^y,A,t,w[v+12],11,-421815835);y=d(A^t^x,y,A,w[v+15],16,530742520);x=d(y^A^t,x,y,w[v+2],23,-995338651);t=g(t,x,y,A,w[v],6,-198630844);A=g(A,t,x,y,w[v+7],10,1126891415);y=g(y,A,t,x,w[v+14],15,-1416354905);x=g(x,y,A,t,w[v+5],21,-57434055);t=g(t,x,y,A,w[v+12],6,1700485571);A=g(A,t,x,y,w[v+3],10,-1894986606);y=g(y,A,t,x,w[v+10],15,-1051523);x=g(x,y,A,t,w[v+1],21,-2054922799);t=g(t,x,y,A,w[v+8],6,1873313359);A=g(A,t,x,y,w[v+15],10,-30611744);y=g(y,A,t,x,w[v+6],15,-1560198380);
x=g(x,y,A,t,w[v+13],21,1309151649);t=g(t,x,y,A,w[v+4],6,-145523070);A=g(A,t,x,y,w[v+11],10,-1120210379);y=g(y,A,t,x,w[v+2],15,718787259);x=g(x,y,A,t,w[v+9],21,-343485551);t=c(t,G);x=c(x,F);y=c(y,O);A=c(A,L)}return[t,x,y,A]}function k(w){var v,t="",x=32*w.length;for(v=0;v<x;v+=8)t+=String.fromCharCode(w[v>>5]>>>v%32&255);return t}function l(w){var v,t=[];t[(w.length>>2)-1]=void 0;for(v=0;v<t.length;v+=1)t[v]=0;var x=8*w.length;for(v=0;v<x;v+=8)t[v>>5]|=(w.charCodeAt(v/8)&255)<<v%32;return t}function n(w){return k(h(l(w),
8*w.length))}function p(w,v){var t=l(w),x=[],y=[];x[15]=y[15]=void 0;16<t.length&&(t=h(t,8*w.length));for(w=0;16>w;w+=1)x[w]=t[w]^909522486,y[w]=t[w]^1549556828;v=h(x.concat(l(v)),512+8*v.length);return k(h(y.concat(v),640))}function u(w){var v="",t;for(t=0;t<w.length;t+=1){var x=w.charCodeAt(t);v+="0123456789abcdef".charAt(x>>>4&15)+"0123456789abcdef".charAt(x&15)}return v}function B(w,v,t){v?t?w=p(unescape(encodeURIComponent(v)),unescape(encodeURIComponent(w))):(w=p(unescape(encodeURIComponent(v)),
...
function getYouTubeIdFromUrl(b){for(var c=$jscomp.makeIterator([/(?:https?:\/\/)?(?:www\.)?youtube\.com\/watch\?v=([0-9A-Za-z_-]+)(?:&.*)?/,/https:\/\/youtu\.be\/([0-9A-Za-z_-]+)/]),d=c.next();!d.done;d=c.next())if(d=b.match(d.value))return d[1];return b}
...
(tmpBookConfig.AboutWebsite=b(d));h&&!tmpBookConfig.AboutDescription&&(tmpBookConfig.AboutDescription=b(h),tmpBookConfig.AboutDescription=HTMLString.toLabel(tmpBookConfig.AboutDescription).replaceAll("&lt;br&gt;","<br>").replace(/\n/g,"<br>"));g&&!tmpBookConfig.AboutAuthor&&(tmpBookConfig.AboutAuthor=b(g));k&&!tmpBookConfig.CompanyLogoFile&&(tmpBookConfig.CompanyLogoFile=b(k));tmpBookConfig.CompanyLogoFile&&(tmpBookConfig.CompanyLogoFile=tmpBookConfig.CompanyLogoFile.replace(/\\/g,"/"));tmpBookConfig.isFlipPdf&&
tmpBookConfig.CompanyLogoFile.startsWith("./")&&(tmpBookConfig.CompanyLogoFile="."+tmpBookConfig.CompanyLogoFile)}},checkHtmlConfig=function(){for(var b="aliasConfig aliasLanguage fliphtml5_pages bmtConfig videoList staticAd language ols slideshow pageEditor flipByAudio downloadconfig assistantConfig phoneNumber bookPlugin shareObj textForPages positionForPages search_pages pages_information bookConfig phoneTemplate userList".split(" "),c=0;c<b.length;c++){var d=b[c];window.htmlConfig&&window.htmlConfig[d]&&
"bookConfig"!=d&&(window[d]=window.htmlConfig[d])}!window.htmlConfig||!window.htmlConfig.downloadConfig||window.htmlConfig.downloadconfig&&void 0==window.htmlConfig.downloadconfig.length||(window.downloadconfig=window.htmlConfig.downloadConfig);try{window.downloadconfig&&0==downloadconfig.isDownloadAttach&&(downloadconfig.attachments=null)}catch(e){}};checkHtmlConfig();
...
try{console&&console.error&&console.error.apply(console,arguments)}catch(b){}this.logForPad(String.format.apply(this,arguments),"red")}},print:function(){var b=String.format.apply(this,arguments),c=(new Date).format("hh:mm:ss.S");this.debug("[%s] %s",c,b)}}}),VERSION_NAME="6.4.9",BUILD_DATE="2025031901",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},
...
function getArticleEditor(){function b(t){if(window.isExecuteGetInverseEditor)var x=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(x),t()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),t(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(y){d(y,t)},t,"")}function c(t,x,y,A,G){var F=new XMLHttpRequest;F.responseType=
void 0===A?"json":A;F.open("GET",t);F.send();F.onreadystatechange=function(){4===F.readyState&&(200===F.status||304===F.status?x&&x(F):"bookinfo"===G&&x?x():y&&y(x))};F.error=function(){y&&y(x)}}function d(t,x){v&&(clearTimeout(v),v=null);if(window.Module.isReady){var y=allocateUTF8(t.responseText),A=Module._DeString(y),G=UTF8ToString(A);G=eval(G);Module._free(y);Module._FreeMemory(A);e(G);x();window.runArticleEditor&&delete window.runArticleEditor}else v=setTimeout(function(){d(t,x)},100)}function e(t){(window.articleListConfig=
t)?g(t):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&p(function(t){window.articleConfig=t.response})}function g(t){for(var x=[],y=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],G=0;G<y;G++){for(var F=A&&A.length&&A[G]?A[G].index:G,O=[],L=0;L<t.length;L++)(t[L].articles?t[L].articles:[]).forEach(function(H){if(H.isShowLinkSplited){if(H.articleTextList&&
...
x:I.rect.x,y:I.rect.y,width:I.rect.width,height:I.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:I.rect.pageWidth,pageHeight:I.rect.pageHeight}:""}I&&H.articleTextList&&H.articleTextList.length&&(H=k(H),M=h(H,I),O.push(M))}});x.push(O)}console.log("currentPageEditor",JSON.parse(JSON.stringify(x)));window.inverseEditor=x}function h(t,x){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
downColor:"#4997ee",outColor:"#4997ee",overAlpha:"0.3",downAlpha:"0.5",outAlpha:"0"});var y=window.articleConfig.hotArea;return{action:{triggerEventType:"mouseDown",actionType:"com.mobiano.flipbook.pageeditor.TAnnoActionShowArticle",articleConfig:t,linkTarget:"showArticle"},annotype:"com.mobiano.flipbook.pageeditor.TAnnoLink",annoId:"202211710188056",isInverse:!0,alpha:"1",overColor:y.overColor,downColor:y.downColor,outColor:y.outColor,overAlpha:y.overAlpha,downAlpha:y.downAlpha,outAlpha:y.outAlpha,
pageViewedBool:"true",ellipseH:"0",ellipseW:"0",location:x,hint:{hintShapeColor:"0",hintShapeColor2:"8388736",hintShapeAlpha:"1",hintW:"0",hintH:"0",hintAuto:"true",hintShapeType:"2",text:""},shadow:{hasDropShadow:"false",shadowDistance:"4",shadowAngle:"270",shadowColor:"0",shadowAlpha:"0.6",shadowBlurX:"4",shadowBlurY:"4"},highlightsBool:"false",linkStatus:"1",mouseOver:"false",borderColor:"16737792"}}function k(t){t=JSON.parse(JSON.stringify(t));t.articleTextList.map(function(x){"text"===x.type&&
(x.text=x.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return x});return{articleId:t.articleId,newTime:t.newTime,title:t.title,subTitle:t.subTitle,author:t.author,categoryId:t.categoryId,articleTextList:t.articleTextList}}function l(t,x){var y=[];t.forEach(function(A){-1!==x&&(A.pageIndex===x||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(G){return G.pageIndex===x}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,x),A.length&&(y=[].concat($jscomp.arrayFromIterable(y),$jscomp.arrayFromIterable(A)))):
y.push(A.rect))});return y}function n(t,x){var y="";t.forEach(function(A){if(-1!==x&&(A.pageIndex===x||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===x}).length))if(""===y)y=A.mergeList&&A.mergeList.length?n(A.mergeList,x):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var G=[y].concat(A.mergeList);y=n(G,x)}y.rect.x>A.rect.x&&(y.rect.x=A.rect.x);y.rect.y>A.rect.y&&(y.rect.y=A.rect.y);y.rect.endX<A.rect.endX&&(y.rect.endX=A.rect.endX);y.rect.endY<
A.rect.endY&&(y.rect.endY=A.rect.endY);y.rect.width=y.rect.endX-y.rect.x;y.rect.height=y.rect.endY-y.rect.y}});return y}function p(t){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,t,u):u(t)}function u(t){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,t,B):B(t)}function B(t){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var x=bookConfig.periodsConfigPath;x=x.replace("%periodicalId%",window.book_visit.periodicalId);c(x,t,w)}else w(t)}
function w(t){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,t):t&&t()}var v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){return t.return(new Promise(function(x,y){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?x():window.runArticleEditor||window.inverseEditor?x():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(y=bookConfig.bookBaseURL)?(y.endsWith("/")||(y+="/"),c(y+"bookinfo.js",function(A){A&&A.response&&
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),n=Math.ceil(k/2),p=b.getContext("2d"),u=p.getImageData(0,0,f,g),B=p.createImageData(c,d);u=u.data;for(var w=B.data,v=0;v<d;v++)for(var t=0;t<c;t++){for(var x=4*(t+v*c),y,A=0,G=0,F=0,O=0,L=0,H=0,I=(v+.5)*k,K=Math.ceil((v+1)*k),M=Math.floor(v*k);M<K;M++){var W=Math.abs(I-(M+.5))/n,Z=(t+.5)*h;W*=W;for(var aa=Math.ceil((t+1)*h),T=Math.floor(t*h);T<aa;T++)if(y=Math.abs(Z-(T+.5))/l,y=
Math.sqrt(W+y*y),!(1<=y)){y=2*y*y*y-3*y*y+1;var U=4*(T+M*f);H+=y*u[U+3];G+=y;255>u[U+3]&&(y=y*u[U+3]/250);F+=y*u[U];O+=y*u[U+1];L+=y*u[U+2];A+=y}}w[x]=F/A;w[x+1]=O/A;w[x+2]=L/A;w[x+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(B,0,0)}
...
!0;b.flipping=!0;var f=.05;if(isIE()||isFirefox())f=0;b.setFlipOriginPoint(e);b.coordinate||(b.coordinate=b.startPoint);var g=b.coordinate.x,h=b.coordinate.y,k,l=this.flippingTime;l=l*Math.abs(b.toPoint.x-g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var p=0;k=function(){n(p,25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,u){n(p,u,"Sine")}.animation(this,l)}.bind(this);var n=function(p,u,B){if(!b)return!1;var w=
b.pageWidth,v=b.pageHeight,t=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,u);x=x(null,p,h,b.toPoint.y-h,u);b.dragMoveToFlip||(B=t(null,p,g,b.toPoint.x-g,u),x=bookConfig.FlipDirection?f*Math.sqrt(v*v-B*B):v-f*Math.sqrt(w*w-B*B));p<u?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",[d]),k.stop())}.bind(this);e()}},setFlipInterval:function(){this.flipInterval=function(){if(!this.flipIntervalManager.flipInterval||
